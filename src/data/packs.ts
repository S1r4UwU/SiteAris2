...
export const PACKS: PackData[] = [
  {
    ...
    description:
      "Protection complète contre les ransomwares et malwares avancés. Déploiement d'agents EDR/XDR sur l'ensemble de votre parc, avec isolation automatique des machines compromises et analyse comportementale en temps réel. Rapports mensuels détaillés et support dédié inclus.",
  ...
  },
  {
    ...
    description:
      "Centre opérationnel de sécurité managé. SIEM cloud-native avec corrélation avancée, intégration de feeds Threat Intelligence, réponse automatisée aux incidents, tableau de bord temps réel et analyste dédié à votre infrastructure.",
